...
musl += locale/catopen.o #- many
libc += locale/duplocale.o
libc += locale/freelocale.o
musl += locale/iconv.o #- LOCALE
musl += locale/iconv_close.o #- LOCALE
#musl += locale/intl.o -- missing -> maybe good
musl += locale/textdomain.o
libc += locale/dcngettext.o
...
#musl += locale/strcasecmp_l.o - GOOD
libc += locale/strcoll.o
libc += locale/strcoll_l.o
#musl += locale/strerror_l.o - GOOD
libc += locale/strfmon.o
libc += locale/strftime_l.o
#musl += locale/strncasecmp_l.o - GOOD
...
#libc += locale/toupper_l.o - GOOD
#musl += locale/towctrans_l.o - GOOD
#libc += locale/towlower_l.o - GOOD
#libc += locale/towupper_l.o - GOOD
...
#musl += locale/wctrans_l.o - GOOD
#libc += locale/wctype_l.o - GOOD
...
musl += network/freeaddrinfo.o #- LOCK/UNLOCK
...
musl += stdio/__stdio_exit.o #__ofl_lock
...
musl += stdio/ext.o
musl += stdio/ext2.o
musl += stdio/fclose.o #__ofl_lock
musl += stdio/feof.o
musl += stdio/ferror.o
musl += stdio/fflush.o #__ofl_lock
libc += stdio/fgetc.o
musl += stdio/fgetln.o
...
libc += stdio/fputc.o
musl += stdio/fputs.o
musl += stdio/fputwc.o #CURRENT_LOCAL
musl += stdio/fputws.o #CURRENT_LOCAL
musl += stdio/fread.o
...
musl += stdio/putchar.o #pthread_impl.h - mess
...
musl += stdio/tempnam.o #__syscall
libc += stdio/tmpfile.o
libc += stdio/tmpnam.o
musl += stdio/ungetc.o
musl += stdio/ungetwc.o #CURRE
...
musl += regex/fnmatch.o #FNM_CASEFOLD
musl += regex/glob.o
