...
ifeq ($(CXX_INCLUDES),)
  ifeq ($(CROSS_PREFIX),aarch64-linux-gnu-)
    ...
    ifeq (,$(gcc-inc-base2))
      $(error Could not find standard libc headers under $(aarch64_gccbase) directory. Please run "./scripts/download_aarch64_packages.py")
    endif
    STANDARD_LIBC_INCLUDES = -isystem $(gcc-inc-base2)
...
INCLUDES += $(STANDARD_LIBC_INCLUDES)
