...
#define ASSERT_STREQ(STR1,STR2) BOOST_CHECK_EQUAL(STR1,STR2)
...
// Taken from libc/platform/bionic/macros.h
...
//To disable
#define RunSingleBufferOverreadTest(FUN) printf("DISABLED: RunSingleBufferOverreadTest\n")
#define RunSrcDstBufferOverreadTest(FUN) printf("DISABLED: RunSrcDstBufferOverreadTest\n")
#define RunCmpBufferOverreadTest(FUN, FUN2) printf("DISABLED: RunCmpBufferOverreadTest\n")
/*
#define RunSingleBufferAlignTest(FUN,X) printf("DISABLED: RunSingleBufferAlignTest\n")
#define RunSrcDstBufferAlignTest(SIZE, FUN, ...) printf("DISABLED: RunSrcDstBufferAlignTest\n")
#define RunCmpBufferAlignTest(...) printf("DISABLED: RunCmpBufferAlignTest\n")
*/
...
TEST(STRING_TEST, strsignal) {
  ...
  // A real-time signal.
  //TODO: ASSERT_STREQ("Real-time signal 14", strsignal(SIGRTMIN + 14));
  // One of the signals the C library keeps to itself.
  //TODO: ASSERT_STREQ("Unknown signal 32", strsignal(__SIGRTMIN));
