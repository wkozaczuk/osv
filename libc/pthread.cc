...
#include <osv/kernel_config_core_default_pthread_stack_size.h>
...
namespace pthread_private {
    ...
    struct thread_attr {
        ...
        cpu_set_t *cpuset;
        sched::cpu *cpu;
        thread_attr() : stack_begin{}, stack_size{CONF_core_default_pthread_stack_size}, guard_size{4096}, detached{false}, cpuset{nullptr}, cpu{nullptr} {}
    };
