...
#if defined(ELF_DEBUG_ENABLED)
#define elf_debug(format,...) kprintf("ELF [%s, tid:%d]: " format, _pathname.c_str(), sched::thread::current()->id() __VA_OPT__(,) __VA_ARGS__)
#else
#define elf_debug(...)
#endif
